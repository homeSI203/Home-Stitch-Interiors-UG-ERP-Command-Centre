...
const routes = [
  ...
  { path: "invoices/[id]", custom: "InvoiceDetailPage" },
  { path: "invoices/[id]/edit", entity: "invoice", kind: "edit" },
  { path: "receipts", entity: "receipt", kind: "list" },
  { path: "receipts/new", entity: "receipt", kind: "create" },
  { path: "receipts/[id]", entity: "receipt", kind: "view" },
  { path: "receipts/[id]/edit", entity: "receipt", kind: "edit" },
  { path: "custom-orders/new", entity: "customOrder", kind: "create" },
  { path: "custom-orders/[id]", custom: "CustomOrderDetailPage" },
  ...
  { path: "custom-orders/[id]/confirm", custom: "ConfirmCustomOrderPage" },
...
const CUSTOM_IMPORTS = {
  ...
  ConfirmCustomOrderPage: '@/components/modules/custom-orders/confirm-custom-order-page',
  CustomOrderDetailPage: '@/components/modules/custom-orders/custom-order-detail-page',
  InvoiceDetailPage: '@/components/modules/invoices/invoice-detail-page',
